...
void RegisterModule(Handle<Object> target) {
	...
	WIRING_DEFINE_CONSTANT("PD25", PD25)
	WIRING_DEFINE_CONSTANT("PD26", PD26)
	WIRING_DEFINE_CONSTANT("PD23", PD23)
	WIRING_DEFINE_CONSTANT("PD21", PD21)
	WIRING_DEFINE_CONSTANT("PD19", PD19)
	WIRING_DEFINE_CONSTANT("PD17", PD17)
	WIRING_DEFINE_CONSTANT("PB2", PB2)
	WIRING_DEFINE_CONSTANT("PD24", PD24)
}
